...
<div class="staff-section margin-cls">
    <div class="container">
    ...
    <div class="container tablebody" style="margin-left: auto !important">
    ...
    <script type="text/javascript">
        ...
        jQuery(function(){
          ...
          if(val) {
            ...
            if(!jQuery( ".doc-table-list").hasClass("alora-training"))
            {
             jQuery('#doc_toolkit option[value="alora-training"]').remove(); 
            }
            
            if(!jQuery( ".doc-table-list").hasClass("devero-training"))
            {
             jQuery('#doc_toolkit option[value="devero-training"]').remove();    
            }
             if(!jQuery( ".doc-table-list").hasClass("kantime-training"))
            {
             jQuery('#doc_toolkit option[value="kantime-training"]').remove();   
            }
}); 
    </script>
    <style type="text/css">
        .staff-section.margin-cls{margin-bottom: 0px!important;}
        .container.tablebody{margin-left:33px!important;}
    </style>
@endpush